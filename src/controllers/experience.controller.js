import { Experience } from "../models/student models/experience.models.js";
...
const getAllExperiences = asyncHandler(async (req, res) => {
    try {
        const { page = 1, limit = 20, company, title, isCurrentJob, sort = '-startDate', select } = req.query;
        ...
        // Build projection
        let projection = '_id title company startDate endDate description createdAt';
        if (select) {
