...
// Admin routes - for viewing any employer's data
 ...
 *         $ref: '#/components/responses/InternalServerError'
 */
employerRouter.get('/potential-students', requestLogger, verifyJWT, authorizeRoles('employer'), getPotentialStudents);

// Admin routes - for viewing any employer's data
/**
 * @swagger
 * /api/v1/employers/{id}/matched-candidates:
 *   get:
 *     summary: Admin - Get matched candidates for any employer by ID
 *     description: Admin endpoint to retrieve matched candidates for any employer
 *     tags: [Employers, Admin]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *         $ref: '#/components/responses/InternalServerError'
 */
employerRouter.get('/matched-candidates', requestLogger, verifyJWT, authorizeRoles('admin'), getEmployerMatchedCandidatesById);

/**
 * @swagger
 * /api/v1/employers/{id}/potential-students:
 *   get:
 *     summary: Admin - Get potential students for any employer by ID
 *     description: Admin endpoint to retrieve potential students for any employer
 *     tags: [Employers, Admin]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *         $ref: '#/components/responses/InternalServerError'
 */
employerRouter.get('/:id/potential-students', requestLogger, verifyJWT, authorizeRoles('admin'), getEmployerPotentialStudentsById);
